...
public class Panel extends JPanel implements KeyListener {
    ...
    public static void faceDir(Point3[] points, char opt, char dir) {
        ...
        Matrix3 moveToZero = MakeOpMatrix(-1 * points[3].getX(), -1 * points[3].getY(), 0);
        ...
        if (opt == 'd') {
            if (dir == 'i') {
                ...
                Matrix3 rotateClk = MakeOpMatrix(Math.cos(-Math.PI / 2), Math.sin(-Math.PI / 2), 2);
                translateObj(points, rotateClk);
            } else {
                Matrix3 rotateClk = MakeOpMatrix(Math.cos(Math.PI / 2), Math.sin(Math.PI / 2), 2);
                translateObj(points, rotateClk);
            ...
            if (dir == 'i') {
                Matrix3 rotateCclk = MakeOpMatrix(Math.cos((Math.PI / 2)), Math.sin((Math.PI / 2)), 2);
                translateObj(points, rotateCclk);
            } else if (dir == 'a') {
                Matrix3 rotateClk = MakeOpMatrix(Math.cos(-1*(3 / 2) * Math.PI), Math.sin(-1*(3 / 2) * Math.PI), 2);
                translateObj(points, rotateClk);
            } else {
                Matrix3 rotateCclk = MakeOpMatrix(Math.cos(-1 * (Math.PI / 2)), Math.sin(-1 * (Math.PI / 2)), 2);
                translateObj(points, rotateCclk);
            }
        } else if (opt == 'i') {
            if (dir == 'd') {
            ...
            Matrix3 rotateClk = MakeOpMatrix(Math.cos((3 / 2) * Math.PI), Math.sin((3 / 2) * Math.PI), 2);
            translateObj(points, rotateClk);
        }
